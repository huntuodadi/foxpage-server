...
import { PROJECT_TYPE, VARIABLE_TYPE } from '../../../config/constant';
    ...
    try {
      ...
      if (params.folderId) {
        ...
        fileListPromise.push(
          this.service.file.list.getFileListByFolderId(params.folderId, { type: VARIABLE_TYPE }),
        );
      }

      if (params.type !== PROJECT_TYPE) {
        ...
        fileListPromise.push(
          this.service.file.list.getFileListByFolderId(appFolderId, { type: VARIABLE_TYPE }),
        );
      }
